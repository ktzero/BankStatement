...
public abstract class Account {
	// A bank account
	  private static int idCounter = 100; //counter that will be used for all Accounts made
	...
	//will automatically assign an ID if not specified
	 ...
	 public String print() 
	 {
		...
		return String.format("%1s %3s %-28s %.2f", 
				  this.getType(), this.getId(), this.getDescription(),
				  this.getBalance());
	 }
